...
const PrivacyPolicy: React.FC = () => {
  return (
    <section className="pt-32 pb-20 px-6 min-h-screen bg-black">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold mb-2 text-white">Privacy Policy</h1>
        <p className="text-gray-500 mb-12 border-b border-white/10 pb-8">Last updated: October 03, 2025</p>
        ...
        <div className="space-y-8 text-gray-400 leading-relaxed text-sm md:text-base">
          ...
          <div>
            ...
            <h4 className="text-lg font-medium text-white mb-2">Personal Data</h4>
            <p className="mb-4">
            ...
            <h4 className="text-lg font-medium text-white mb-2">Usage Data</h4>
          ...
          <div>
             ...
             <h4 className="text-lg font-medium text-white mb-2">Business Transactions</h4>
             <p className="mb-4">
             ...
             <h4 className="text-lg font-medium text-white mb-2">Other legal requirements</h4>
             <p className="mb-4">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
               ...
               <li>By visiting this page on our website: <a href={LINKS.GITHUB} className="text-blue-500 hover:text-blue-400 underline" target="_blank" rel="noopener noreferrer">{LINKS.GITHUB}</a></li>
            </ul>
          </div>
